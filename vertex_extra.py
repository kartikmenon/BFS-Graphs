...
class Vertex:
    ...
    def on_vertex(self, x, y):
        return (int(self.x) - VERTEX_RADIUS < x < int(self.x) + VERTEX_RADIUS) and (int(self.y) - VERTEX_RADIUS < y < int(self.y) + VERTEX_RADIUS)
    

    def print_name(self, x, y):
        set_stroke_color(0, 0, 0)
        draw_text(str(self.name), x, y)